...
export CLIENT_HOSPITAL_ID=${CLIENT_HOSPITAL_ID:-hospital_1}
export CLIENT_CSV_PATH=${CLIENT_CSV_PATH:-"$REPO_ROOT/datasets/Medicaldataset.csv"}
export CLIENT_TARGET_COLUMN=${CLIENT_TARGET_COLUMN:-Result}
...
echo "Starting client agent (hospital_1)..."
