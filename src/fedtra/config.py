...
class Config:
    ...
    BATCH_SIZE = 32
    LEARNING_RATE = 0.001
    # FedProx proximal coefficient (0.0 disables FedProx and preserves current behavior)
    FEDPROX_MU = 0.0
    ...
    # Label handling / validation
    ENFORCE_NUM_CLASSES = True  # Ensure derived number of classes matches NUM_CLASSES
